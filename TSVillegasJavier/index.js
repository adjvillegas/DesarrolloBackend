...
const operacion = (val1, val2, operacion) => __awaiter(void 0, void 0, void 0, function* () {
    switch (operacion) {
        case 'sumar':
            let { default: suma } = yield Promise.resolve().then(() => __importStar(require('./sumaClass')));
            let sumar = new suma(val1, val2);
            return sumar.resultado();
        case 'restar':
            let { default: resta } = yield Promise.resolve().then(() => __importStar(require('./restaClass')));
